...
-- Description: Complete database schema with tables, enums, indexes, RLS, and triggers
-- ============================================================================
...
COMMENT ON COLUMN cows.cow_number IS '奶牛唯一编号';
...
COMMENT ON COLUMN health_records.temperature IS '体温，≥39.5°C触发预警';
...
-- ============================================================================
-- SECTION 6: ROW LEVEL SECURITY (RLS) - See supabase-rls.sql
-- ============================================================================

-- RLS policies are defined in a separate file (supabase-rls.sql)
-- This allows for easier management and testing of security policies
